...
#include <fstream>
#include <algorithm>
#include <string>  //jagozal added this library 10/7/16
#include <sstream> //jagonzal added this library 10/7/16
...
void getInput();
std::string IntToStr(int t); //jagonzal added this function 10/7/16
...
//  std::ofstream testoutput("test.txt");	//track firm 6 if anotation switch is on
  ...
  //more declarations
  int rank, size; //10/7/16 used for parallelization
  ...
  //Dynamically create output file 10/7/16
